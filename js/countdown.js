	...
	$.extend({
		'countdown' : function(options) {
			...
			var flip = function(location, number, maxNumber) {
				...
				$lastUp.attr({
					'src' : options.img.urlUp + (number == maxNumber ? 0 : number + 1) + options.img.type,
					'style' : ''
				});
			...
			/**
	         * @description 灏嗕竴涓椂闂村樊杞崲鎴恱澶﹛鏃秞鍒唜绉�
	         * @param {Number} num  鏃堕棿宸�
	         * @return {String} x澶﹛鏃秞鍒唜绉�
	         */
			...
			var countdown_main = function(endTime) {
				...
				var t = to_dhms(remianTime), day1 = Math.floor(t[0] / 10), day2 = t[0] % 10, hours1 = Math.floor(t[1] / 10), hours2 = t[1] % 10, minutes1 = Math.floor(t[2] / 10), minutes2 = t[2] % 10, seconds1 = Math.floor(t[3] / 10), seconds2 = t[3] % 10;
				flip('#day1', day1, 9);
				flip('#day2', day2, 9);
